...
if not isfolder(".Annie/BloxFruit/Kaitun/") then
   ...
   local badtimedicac = os.time()
         if not isfile(".LunarX/BloxFruit/Kaitun/eslapedtime."..game.Players.LocalPlayer.Name) then
        
         writefile(".LunarX/BloxFruit/Kaitun/eslapedtime."..game.Players.LocalPlayer.Name, "0")
         esltime = 0 
         end 
   ctent2 = readfile(".LunarX/BloxFruit/Kaitun/eslapedtime."..game.Players.LocalPlayer.Name)
   function updatetime()
      if not isfile(".LunarX/BloxFruit/Kaitun/eslapedtime."..game.Players.LocalPlayer.Name) then
         ...
         ctent = readfile(".LunarX/BloxFruit/Kaitun/eslapedtime."..game.Players.LocalPlayer.Name)
         if tonumber(ctent) or ctent == "0" or ctent == "1" then
            esltime = tonumber(ctent2 or 0) + (os.time()-(badtimedicac or os.time()))
            writefile(".LunarX/BloxFruit/Kaitun/eslapedtime."..game.Players.LocalPlayer.Name, tostring(esltime))
...
Info:AddLabel("Lunar X Community Kaitun Script") 
