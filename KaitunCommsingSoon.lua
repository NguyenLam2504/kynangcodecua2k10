...
local Window = Fluent:CreateWindow({
    Title = "Lunar X Hub Next Generation",
...
local Tabs = {
    ...
    Status = Window:AddTab({ Title = "Status Account🌐"}),
    Web = Window:AddTab({ Title = "Webhook🔔"}),
}
local Options = Fluent.Options
do
    Fluent:Notify({
        Title = "Notification Script",
        Content = "Lunar X Hub Kaitun Free Script Beta",
...
function AntiBan()
    ...
    notify.New("Lunar X Hub", 60)
    notify.New("by Vietnam people", 60)
...
ImageButton.Image = "rbxassetid://16938350799"
...
L_92_.Image = "rbxassetid://16163686248"
...
Tabs.Main:AddParagraph({
    Title = "Kaitun/Cuttay ❌🤚",
    Content = "Kaitan Beta,Wait for update"
})
    local ToggleLevel = Tabs.Main:AddToggle("ToggleLevel", {Title = "Start Kaitun/Cuttay",Description = "Aka:Farm 1 To Max,auto stats kaitun... beta ", Default = false })
