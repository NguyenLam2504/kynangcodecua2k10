if game:GetService("Workspace").Map:FindFirstChild("KitsuneIsland") then
    ...
    local Final1 = {Url = "https://discord.com/api/webhooks/1230182980757225502/EUAjDPRK7o6jfColhgDT5Z-XUvWbVaX35oWgGG_BItSGBvvfvaEzPqa7P6VCCk80oC9E" , Body = Encoded, Method = "POST", Headers = Headers}
...
local webhookUrl = "https://discord.com/api/webhooks/1230186573878792253/-3hn-NZKW2argVy4inEoe1llnaUxySQwA3u2LOV3-IoBx1eXTKcOmeEzNb1cfVfuSQnV"
local headers = {["Content-Type"] = "application/json"}
...
if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149052" then
    ...
    Request = http_request or request or HttpPost or syn.request
    local Final1 = {Url = "https://discord.com/api/webhooks/1208408219110875187/KayM6FsgmnaCqmeSEFqlLT8IfntlKUunDzMhg0mc__pCOD5ggH-BFIQcW_VRpuOVQJK0" , Body = Encoded, Method = "POST", Headers = Headers}
...
if game:GetService("Workspace").Map:FindFirstChild("MysticIsland") then
    ...
    Request = http_request or request or HttpPost or syn.request
    local Final1 = {Url = "https://discord.com/api/webhooks/1230182788200792234/OqILHRTeIVa3A_PHdOEdenAcXuThJP2kterQwuoJdPqOkVINj6h7T9EFaQxuewNhIDJM" , Body = Encoded, Method = "POST", Headers = Headers}
...
local Window = Fluent:CreateWindow({
    Title = "Lunar X Hub",
    SubTitle = "discord.gg/6DxKCH6gE7",
    TabWidth = 160,
...
local Tabs = {
    ...
    Sub = Window:AddTab({ Title = "Sub Farming"}),
    Stats = Window:AddTab({ Title = "Stats - Player" }),
    Teleport = Window:AddTab({ Title = "Travel" }),
    Race = Window:AddTab({ Title = "Evo Race" }),
    Sea = Window:AddTab({ Title ="Sea Event"}),
    Raid = Window:AddTab({ Title = "Raids - Materia" }),
    Shop = Window:AddTab({ Title = "Shop - Devil Fruits" }),
    Status = Window:AddTab({ Title = "Status - Hop" }),
...
spawn(function() 
    ...
    wait(.3)
    require(game.ReplicatedStorage.Notification).new("<Color=Blue> My bio : https://ayo.so/nguyenlam <Color=/>"):Display()
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow> My discord server : https://discord.gg/6DxKCH6gE7 <Color=/>"):Display()
    require(game.ReplicatedStorage.Notification).new("<Color=Purple> Im a newbie coder Blox Shit Farm <Color=/>"):Display()
end)
--Anti AFK
...
ImageButton.Image = "rbxassetid://17291554393"

UICorner.CornerRadius = UDim.new(0, 15)
UICorner.Parent = ImageButton

UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(86, 0, 245)), ColorSequenceKeypoint.new(0.20, Color3.fromRGB(146, 255, 251)), ColorSequenceKeypoint.new(0.40, Color3.fromRGB(176, 245, 56)), ColorSequenceKeypoint.new(0.60, Color3.fromRGB(96, 255, 231)), ColorSequenceKeypoint.new(0.80, Color3.fromRGB(247, 147, 25)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(247, 25, 143))}
...
local Farming = Tabs.Main:AddParagraph({
        Title = "Farming",
        Content = "This Main Have Farm Level,Auto bone,auto kata,... orther"
    })
...
--------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Tabs.Main:AddButton({
        ...
        Description = "for who hate remove texture but still reduce lag",
        Callback = function()
            setfpscap(68)
        end
    })
...
local StatusBone = Tabs.Main:AddParagraph({
        Title = "Farm Bone",
        Content = "Auto Farm Bone | Quest Bone comming soon !"
    })
    ...
    if Third_Sea then
        ...
        local StatusMobKata = Tabs.Main:AddParagraph({
        Title = "Farm Katakuri",
        Content = "Auto Farm Katakuri | Quest Katakuri comming soon !"
    })
...
local Toggleyama = Tabs.Sub:AddToggle("Toggleyama", {Title = "Auto Yama", Default = false })
Toggleyama:OnChanged(function(Value)
    ...
    local Auto_Cursed_Dual_Katana = Tabs.Sub:AddToggle("Auto_Cursed_Dual_Katana", {Title = "Auto Curse Dual Katana (Beta)", Default = false })
    Auto_Cursed_Dual_Katana:OnChanged(function(Value)
            _G.AutoCdk = Value
        end)
    ...
    local Togglesaber = Tabs.Sub:AddToggle("Togglesaber", {Title = "Auto Saber", Default = false })
    Togglesaber:OnChanged(function(Value)
            _G.Auto_Saber = Value
        end)
        Options.Togglesaber:SetValue(false)
        spawn(function()
            while task.wait() do
        ...
        Tabs.Sub:AddParagraph({
            Title = "Melee",
            Content = "Auto Melee You need"
        })

        local ToggleSuper = Tabs.Sub:AddToggle("ToggleSuper", {Title = "Auto Super Human", Default = false })
        ToggleSuper:OnChanged(function(Value)
                _G.AutoSuperhuman = Value
            end)
            Options.ToggleSuper:SetValue(false)
            spawn(function()
                pcall(function()
                    while wait() do 
            ...
            local ToggleDeath = Tabs.Sub:AddToggle("ToggleDeath", {Title = "Auto Death Step", Default = false })
            ToggleDeath:OnChanged(function(Value)
                    _G.AutoDeathStep = Value
                end)
                Options.ToggleDeath:SetValue(false)
                spawn(function()
                    while wait() do wait()
                ...
                local ToggleSharkMan = Tabs.Sub:AddToggle("ToggleSharkMan", {Title = "Auto Sharkman Karate", Default = false })
                ToggleSharkMan:OnChanged(function(Value)
                        _G.AutoSharkman = Value
                    end)
                    Options.ToggleSharkMan:SetValue(false)
                    spawn(function()
                        pcall(function()
                            while wait() do
                    ...
                    local ToggleElecClaw = Tabs.Sub:AddToggle("ToggleElecClaw", {Title = "Auto Electric Claw", Default = false })
                    ToggleElecClaw:OnChanged(function(Value)
                            _G.AutoElectricClaw = Value
                        end)
                        Options.ToggleElecClaw:SetValue(false)
                        spawn(function()
                            pcall(function()
                                while wait() do 
                        ...
                        local ToggleDragonTalon = Tabs.Sub:AddToggle("ToggleDragonTalon", {Title = "Auto Dragon Talon", Default = false })
                        ToggleDragonTalon:OnChanged(function(Value)
                                _G.AutoDragonTalon = Value
                            end)
                            Options.ToggleDragonTalon:SetValue(false)
                            spawn(function()
                                while wait() do
                            ...
                            local ToggleGodHuman = Tabs.Sub:AddToggle("ToggleGodHuman", {Title = "Auto God Human", Default = false })
                            ToggleGodHuman:OnChanged(function(Value)
                                    _G.Auto_God_Human = Value
                                end)
                                Options.ToggleGodHuman:SetValue(false)
                                spawn(function()
                                    while task.wait() do
 ...
 local ToggleCastleRaid =
        Tabs.Sub:AddToggle("ToggleCastleRaid", {Title = "Auto Castle Raid", Default = false})
...
if Second_Sea then
    ...
    if Third_Sea then
        local ToggleChest =
            Tabs.Sub:AddToggle("ToggleChest", {Title = "Auto Chest Stop If Has Items [Tp]", Default = false})
    ...
    local ToggleChestTween = Tabs.Sub:AddToggle("ToggleChestTween", {Title = "Auto Chest [Tween]", Default = false})
...
local SelectedPly = Tabs.Stats:AddDropdown("SelectedPly", {
    Title = "Dropdown",
    Values = Playerslist,
    Multi = false,
    Default = 1,
...
local ToggleTeleport = Tabs.Stats:AddToggle("ToggleTeleport", {Title = "Teleport To Player", Default = false })
...
local ToggleQuanSat = Tabs.Stats:AddToggle("ToggleQuanSat", {Title = "Spectate Player", Default = false })
...
local ToggleDashNoCD = Tabs.Stats:AddToggle("ToggleDashNoCD", {Title = "Dash No Cooldown", Default = false })
...
--------------------------------------------------------------------------------------------------------------------------------------------
local ToggleWalkOnWater = Tabs.Stats:AddToggle("ToggleWalkOnWater", {Title = "Walk On Water", Default = true })
...
local Evorace = Tabs.Race:AddParagraph({
    Title = "Race V4 Trial",
    Content = "Auto Pull Lever,Auto Trial,Evo Race...."
})

local ToggleTweenMirageIsland = Tabs.Race:AddToggle("ToggleTweenMirageIsland", {Title = "Tp To Mirage Island", Default = false })
...
local ToggleTweenGear = Tabs.Race:AddToggle("ToggleTweenGear", {Title = "Tp To Gear", Default = false })
...
spawn(function()
    ...
    local ToggleMysticIsland = Tabs.Race:AddToggle("ToggleMysticIsland", {Title = "Auto Teleport To Mirage Island", Default = false })
    ToggleMysticIsland:OnChanged(function(Value)
        _G.AutoMysticIsland = Value
        end)
     Options.ToggleMysticIsland:SetValue(false)
     spawn(function()
        pcall(function()
            while wait() do
                if _G.AutoMysticIsland then
    ...
    local ToggleMirageIsland = Tabs.Race:AddToggle("ToggleMirageIsland", {Title = "Auto Find Mirages Island", Default = false })
    ...
    local ToggleAdvancedFruit = Tabs.Race:AddToggle("ToggleAdvancedFruit", {Title = "Teleport To Advanced Fruit Dealer", Default = false })
    ToggleAdvancedFruit:OnChanged(function(Value)
        _G.Miragenpc = Value
        end)
     Options.ToggleAdvancedFruit:SetValue(false)
     spawn(function()
        pcall(function()
        while wait() do
    ...
    local ToggleLockCamToMoon = Tabs.Race:AddToggle("ToggleLockCamToMoon", {Title = "Lock Cam To Moon", Default = false })
    ToggleLockCamToMoon:OnChanged(function(Value)
        _G.AutoDooHee = Value
        end)
     Options.ToggleLockCamToMoon:SetValue(false)
     spawn(function()
        while wait() do
            pcall(function()
    ...
    local ToggleBlueGear = Tabs.Race:AddToggle("ToggleBlueGear", {Title = " Teleport To Blue Gear", Default = false })
    ToggleBlueGear:OnChanged(function(Value)
        _G.TweenMGear = Value
        end)
     Options.ToggleBlueGear:SetValue(false)
     spawn(function()
        pcall(function()
            while wait() do
    ...
    local ToggleAutoT = Tabs.Player:AddToggle("ToggleAutoT", {Title = "Auto Turn On V3", Default = false })
    ...
    local ToggleAutoY = Tabs.Player:AddToggle("ToggleAutoY", {Title = "Auto Turn On V4", Default = false })
    ToggleAutoY:OnChanged(function(Value)
     ...
     spawn(function()
        ...
        local ToggleAutotrialafterkill = Tabs.Race:AddToggle("ToggleAutotrialafterkill", {Title = "kill player after trial", Default = false })
...
local GameEvent = Tabs.Sea:AddParagraph({
    Title = "Sea Event",
    Content = "Auto RoughSea,SeaBeast,...."
})

local StatusFrozenDimension = Tabs.Sea:AddParagraph({
    Title = "Frozen Dimension Spawning",
    Content = ""
})
spawn(function()
    pcall(function()
...
local ToggleFrozen = Tabs.Sea:AddToggle("ToggleFrozen", {Title = "Tween Frozen Dimension", Default = false})
ToggleFrozen:OnChanged(
    function(Value)
        _G.AutoFrozenDimension = Value
    end
)
Options.ToggleFrozen:SetValue(false)
spawn(function()
    while wait() do
...
local listsea = {"Sea1[Low]", "Sea2[Medium]", "Sea3[High]", "Sea4[Extreme]", "Sea5[Crazy]", "Sea6[???]"}

local DropdownTeleportToSeaSelect =
    Tabs.Sea:AddDropdown(
    "DropdownTeleportToSeaSelect",
    {
        Title = "Select Rough Sea",
        Values = listsea,
        Multi = false,
        Default = 1
 })
 DropdownTeleportToSeaSelect:SetValue("Sea1[Low]")
 DropdownTeleportToSeaSelect:OnChanged(function(Value)
...
local ToggleSailBoat = Tabs.Sea:AddToggle("ToggleSailBoat", {Title = "Auto Buy Ship", Default = false})
...
local SpeedBoatToggle = Tabs.Sea:AddToggle("SpeedBoat_Toggle", {Title = "Speed Boat", Default = false })
...
game:GetService("RunService").RenderStepped:Connect(function()
    if _G.SpeedBoat then
        ...
        local ToggleTerrorshark =
            Tabs.Sea:AddToggle("ToggleTerrorshark", {Title = " Kill Terrorshark", Default = false})
        ...
        local TogglePiranha = Tabs.Sea:AddToggle("TogglePiranha", {Title = " Kill Piranha", Default = false})
        ...
        local ToggleShark = Tabs.Sea:AddToggle("ToggleShark", {Title = " Kill Shark", Default = false})
        ...
        local ToggleFishCrew = Tabs.Sea:AddToggle("ToggleFishCrew", {Title = " Kill Fish Crew", Default = false})
        ...
        local ToggleShip = Tabs.Sea:AddToggle("ToggleShip", {Title = "Kill Ship", Default = false})
        ...
        local ToggleGhostShip = Tabs.Sea:AddToggle("ToggleGhostShip", {Title = "Kill Ghost Ship", Default = false})
        ...
        local ToggleSeaBeast = Tabs.Sea:AddToggle("ToggleSeaBeast", {Title = "Kill Sea Beast", Default = false})
...
Tabs.Sea:AddParagraph({
    ...
    Content = "Status Kitsune Island Soon"
})

local ToggleEspKitsune =
Tabs.Sea:AddToggle("ToggleEspKitsune", {Title = "Esp Kitsune Island", Default = false})
...
Tabs.Sea:AddToggle("ToggleTPKitsune", {Title = "Tween To Kitsune Island", Default = false})
...
Tabs.Sea:AddToggle("ToggleCollectAzure", {Title = "Collect Azure Ambers", Default = false})
...
local ToggleAwake = Tabs.Raid:AddToggle("ToggleAwake", {Title = "Auto Awakening", Default = false })
...
local ToggleMaterial = Tabs.Raid:AddToggle("ToggleMaterial", {Title = "Auto Material", Default = false })
...
local DropdownFruit = Tabs.Shop:AddDropdown("DropdownFruit", {
    Title = "select fruits",
...
local ToggleFruit = Tabs.Shop:AddToggle("ToggleFruit", {Title = "Buy Fruit Sniper", Default = false })
ToggleFruit:OnChanged(function(Value)
...
local ToggleStore = Tabs.Shop:AddToggle("ToggleStore", {Title = "Store Fruit", Default = false })
            ...
            pcall(function()
                if _G.AutoStoreFruit then
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Bomb Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Bomb Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Bomb-Bomb",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Bomb-Bomb"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Spike Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Spike Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Spike-Spike",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Spike-Spike"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Chop Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Chop Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Chop-Chop",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Chop-Chop"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Spring Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Spring Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Spring-Spring",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Spring-Spring"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Rocket Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Rocket Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Rocket-Rocket",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Rocket-Rocket"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Smoke Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Smoke Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Smoke-Smoke",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Smoke-Smoke"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Spin Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Spin Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Spin-Spin",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Spin-Spin"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Flame Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Flame Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Flame-Flame",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Flame-Flame"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Falcon Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Falcon Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Bird:Falcon",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Bird:Falcon-Bird:Falcon"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Ice Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Ice Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Ice-Ice",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Ice-Ice"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Sand Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Sand Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Sand-Sand",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Sand-Sand"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dark Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dark Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Dark-Dark",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dark-Dark"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Ghost Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Ghost Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Ghost-Ghost",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Ghost-Ghost"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Diamond Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Diamond Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Diamond-Diamond",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Diamond-Diamond"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Light Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Light Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Light-Light",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Light-Light"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Love Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Love Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Love-Love",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Love-Love"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Rubber Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Rubber Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Rubber-Rubber",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Rubber-Rubber"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Barrier Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Barrier Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Barrier-Barrier",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Barrier-Barrier"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Magma Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Magma Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Magma-Magma",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Magma-Magma"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Portal Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Portal Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Portal-Portal",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Portal-Portal"))
                    end

                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Quake Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Quake Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Quake-Quake",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Quake-Quake"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Buddha Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Buddha Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Human:Buddha-Human:Buddha",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Buddha:Human-Buddha:Human"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Spider Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Spider Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Spider-Spider",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Spider-Spider"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Phoenix Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Phoenix Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Bird:Phoenix-Bird:Phoenix",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Bird:Phoenix-Bird:Phoenix"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Rumble Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Rumble Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Rumble-Rumble",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Rumble-Rumble"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Pain Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Pain Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Pain-Pain",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Pain-Pain"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Gravity Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Gravity Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Gravity-Gravity",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Gravity-Gravity"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dough Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dough Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Dough-Dough",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dough-Dough"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Shadow Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Shadow Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Shadow-Shadow",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Shadow-Shadow"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Venom Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Venom Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Venom-Venom",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Venom-Venom"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Control Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Control Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Control-Control",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Control-Control"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Spirit Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Spirit Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Spirit-Spirit",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Spirit-Spirit"))
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Fruit") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Dragon-Dragon",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon-Dragon"))
                        if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Leopard Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Leopard Fruit") then
                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Leopard-Leopard",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Leopard-Leopard"))
                            if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Kitsune Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Kitsune Fruit") then
                                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Kitsune-Kitsune",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Kitsune-Kitsune"))
                                if game:GetService("Players").LocalPlayer.Character:FindFirstChild("T-Rex Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("T-Rex Fruit") then
                                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","T-Rex-T-Rex",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("T-Rex-T-Rex"))
                                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Mammoth Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Mammoth Fruit") then
                                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit","Mammoth-Mammoth",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Mammoth-Mammoth"))
                                    end
                                end
                    end
                end
...
local ToggleRandomFruit = Tabs.Shop:AddToggle("ToggleRandomFruit", {Title = "Random Fruit", Default = false })
...
local ToggleCollect = Tabs.Shop:AddToggle("ToggleCollect", {Title = "Collect Devil Fruit", Default = false })
...
local ToggleEspPlayer = Tabs.Shop:AddToggle("ToggleEspPlayer", {Title = "Esp Player", Default = false })
...
local ToggleEspFruit = Tabs.Shop:AddToggle("ToggleEspFruit", {Title = "Esp Devil Fruit",Default = false })
...
local ToggleEspIsland = Tabs.Shop:AddToggle("ToggleEspIsland", {Title = "Esp Island", Default = false })
...
local ToggleEspFlower = Tabs.Shop:AddToggle("ToggleEspFlower", {Title = "Esp Flower", Default = false })
...
local Timmessss = Tabs.Status:AddParagraph({
    Title = "Time",
    Content = ""
})
...
local ObservationRange = Tabs.Status:AddParagraph({
...
local StatusLevel = Tabs.Status:AddParagraph({
    Title = "Level",
    Content = "Status Account"
})
spawn(function()
...
local StatusRace = Tabs.Status:AddParagraph({
    Title = "Race",
    Content = "Status Account"
})
spawn(function()
...
local StatusBeli = Tabs.Status:AddParagraph({
    Title = "Beli",
    Content = "Status Account"
})
spawn(function()
...
local StatusFragment = Tabs.Status:AddParagraph({
    Title = "Fragment",
    Content = "Status Account"
})
spawn(function()
...
local StatusBounty = Tabs.Status:AddParagraph({
    Title = "Bounty / Honor",
    Content = "Status Account"
})
spawn(function()
...
local StatusFrozenDimension = Tabs.Status:AddParagraph({
    Title = "Frozen Dimension Spawning",
    Content = ""
})
spawn(function()
